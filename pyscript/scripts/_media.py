...
# def play_emilys_playlist(**kwargs) -> None:
...
# def play_ellies_playlist(**kwargs) -> None:
#     caller = kwargs['caller']
#     if state.get(f"person.{caller}") == "home":
#         input_select.select_option(entity_id="input_select.media_card_playlist", option="None Selected")
...
# def bedtime_speaker_volume() -> None:
...
# def persist_media_card() -> None:
#     state.persist(
#         "pyscript.media_card",
#         default_value="controls" -> None,
...
# def set_media_card_playlists() -> None:
...
# def play_media_card_playlist() -> None:
#     hass_startup_time = dates.parse_timestamp(sensor.home_assistant_uptime)
...
# )
# def sync_volume(target="media_player.living_room", **kwargs) -> None:
...
# def group_speakers(target="media_player.living_room") -> None:
#     for speaker in constants.MAIN_FLOOR_SPEAKERS:
...
# def ungroup_speakers(target=None) -> None:
#     if target:
